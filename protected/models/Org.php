 ...
 * @property EstateType[] $estateTypes
...
class Org extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'estateTypes' => array(self::HAS_MANY, 'EstateType', 'orgId'),
			'orgUsers' => array(self::HAS_MANY, 'OrgUser', 'orgId'),
			'positions' => array(self::HAS_MANY, 'Position', 'orgId'),
		);
	}
